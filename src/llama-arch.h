...
enum llm_kv {
    ...
    LLM_KV_ROBOTTRACK_MAX_TIME_STEPS,
    LLM_KV_ROBOTTRACK_NUM_WAYPOINTS,
    LLM_KV_ROBOTTRACK_ACTION_DIM,
...
enum llm_tensor {
    ...
    LLM_TENSOR_CLS_OUT,
    LLM_TENSOR_CLS_NORM,
    LLM_TENSOR_TRAJ_TIME_EMBD,
    LLM_TENSOR_TRAJ_STREAM_EMBD,
    LLM_TENSOR_TRAJ_CAMERA_EMBD,
    LLM_TENSOR_TRAJ_CONTROL,
    LLM_TENSOR_TRAJ_NORM_IN,
    LLM_TENSOR_TRAJ_FC1,
    LLM_TENSOR_TRAJ_FC2,
    LLM_TENSOR_TRAJ_FC3,
    LLM_TENSOR_TRAJ_FC4,
    LLM_TENSOR_TRAJ_FC5,
    LLM_TENSOR_TRAJ_NORM_OUT,
    LLM_TENSOR_TRAJ_OUT,
    LLM_TENSOR_TRAJ_OUT_SCALE,
    LLM_TENSOR_CONV1D,
